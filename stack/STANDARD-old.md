# STANDARD.md — Indie Project Standard Stack (PRE-REFACTOR SNAPSHOT)

> ⚠️ **This is a frozen snapshot taken 2026-04-22 before the AI/Human ownership
> refactor.** Kept for diff / rollback purposes. The active STANDARD is in
> `STANDARD.md`. Delete this file once the refactor has stabilized and you no
> longer need to refer back.
