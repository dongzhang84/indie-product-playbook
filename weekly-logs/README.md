...
|---|---|---|
| [Week&nbsp;22](week-22-2026-08-08.md) | 8/8&nbsp;&#8209;&nbsp;8/14 | **8/11 一天定调整周、科研线两格同时爆发**：那天一次做了四件事——相对论论文进定稿冲刺、Classical Particles 立卡进科研③、求职定下「只投 modeling/Scientist track」铁律后连投 6 个、Block 终面三场连轴转，本周实质进展几乎都从这天往外辐射。**科研线两个格子同时动是近两个月首次**：《Can AI Rediscover Relativity?》97 commit，正文与附录基本定稿，8/14 发推公开锁定 position paper 格式；Classical Particles 三天 65 commit，从空 repo 写出 AASTeX 笔记初稿（8/13 引入 Codex 交叉校对）。平行线双高：百日百篇 #93–97 **全周 100k**（地板 14k、峰值 26k，有记录以来最高），求职 13 投 + **Block 四场终面本周内全部跑完**，GE HealthCare 过筛选约到 8/19–20、Cresta 8/10 拒。资助线 0 投却撞见 **LTFF 已于 8/11 永久关闭**（TAIF 接替）——放着不管的清单，连它是否还成立都不知道。代价仍在产品线（三格两个 0 commit）与教育线（整周 0 投、UW PCE 面谈记录欠账第 4 周） |
...
| [Week&nbsp;20](week-20-2026-07-25.md) | 7/25&nbsp;&#8209;&nbsp;7/31 | **对外线提速的一周**：两笔硬截止的资助如期清完（Anthropic Fellows 7/25 提交、grantmaking.ai 被判"疑似 AI 生成"，补交本人出镜视频），SFF/LTFF/Manifund/EV 顺延；**DeepMind 的 Zahavy 用零实验 position paper 撞题并被 ICML 2026 接收**，倒逼出一整套 visibility 反击计划（推文 / outreach 邮件 / 自投 position paper）；内容线五篇 #83–87，《大数据概念兴衰史》13.1k；求职与教学申请持续进行，面试在推进中 |
...
| [Week&nbsp;2](week-02-2026-03-21.md) | 3/21&nbsp;&#8209;&nbsp;3/27 | LaunchRadar, ProfitPilot MVP, AceRocket workflow |
| [Week&nbsp;1](week-01-2026-03-14.md) | 3/14&nbsp;&#8209;&nbsp;3/20 | AI Video Pick, Socrates Finds You, Trend Monitor |

## Naming Convention

`week-NN-YYYY-MM-DD.md` — week number + starting date (Saturday).
