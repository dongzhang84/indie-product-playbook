...
|---|---|---|
| [Week&nbsp;20](week-20-2026-07-25.md) | 7/25&nbsp;&#8209;&nbsp;7/31 | **对外线全面提速、内部线继续失血**：找工作三周下滑后反弹到 **16 投**，**Block 通过 Assessment 进 4 场终面**；两笔硬截止资助如期清完（Anthropic Fellows 7/25 提交、grantmaking.ai 被判"疑似 AI 生成"补出镜视频），但自排的 SFF/LTFF/Manifund/EV 全部落空；**DeepMind 的 Zahavy 用零实验 position paper 撞题并被 ICML 2026 接收**，倒逼出一整套 visibility 反击计划（推文/邮件/自投 position paper，全部仍待执行）；内容线五篇 #83–87，《大数据概念兴衰史》13.1k；Physics Model Library 连续第二周 0 commit，产品线三格全 0 |
