...
|---|---|---|
| [Week&nbsp;21](week-21-2026-08-01.md) | 8/1&nbsp;&#8209;&nbsp;8/7 | **内容与求职双高、三三制九宫格几乎全空**：百日百篇 138 commit 连发 #88–92 创全期新高，求职线 13 投 + **一周 5 场面试**（Qualtrics 跳过 HR 直接 HM 面、Sardine 投出两天即面、Cresta 把"用 AI 编程"单列一轮）；九个格子里 **7 个 0 commit**，教育 0 投、资助整周 0 动作。唯一实质科研产出是 **visibility 计划第三步落地**——《Can AI Rediscover Relativity?》草稿 + ICML LaTeX 四天写成，但它不在九宫格里；邮箱核实翻出 Week 20 的误记：**给 Zahavy 的邮件 7/30 已发且当天收到本人回信** |
